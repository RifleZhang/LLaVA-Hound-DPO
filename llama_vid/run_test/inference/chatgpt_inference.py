...
from run_test.utils import format_docstring, load_jsonl, load_json, save_jsonl, save_json

DEBUG_MESSAGE='Q1: What is the brand name of the motorcycle featured in the video?\nA1: The brand name of the motorcycle is "R", which is prominently displayed on it.\n\nQ2: How does the dog behave around the motorcycle?\nA2: The dog approaches the motorcycle in a gentle and exploratory manner, sniffing and moving around it out of curiosity. There is no interaction with the motorcycle\'s controls or any other objects.\n\nQ3: What are some distinctive features of the motorcycle shown in the video?\nA3: The motorcycle has a red reflector on the front and a black seat. The brand name "R" is prominently displayed, and it is parked on a paved surface.'
...
def chatgpt_inference(data, prompt_template, output_dir, output_path, num_tasks=1,  
    ...
    while True:
        try:
            ...
            # single proc
            # annotate(data[0], prompt_template, 

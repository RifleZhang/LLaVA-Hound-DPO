    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        try:
            ...
            if 'image' in self.list_data_dict[i]:
                ...
                # print('success video')
            else: # use video as default
                # data_dict['video'] = torch.zeros(3, 8, 224, 224)
                data_dict['image'] = torch.zeros(3, 224, 224) # placeholder, will not be used, search "MARK: Text only" in llava_arch.py

    ...
    def process_result(self, results_dir):
        ...
        for eval_type, task_name_list in eval_type_dict.items():
            ...
            for task_name in task_name_list:
                ...
                task_txt = os.path.join(results_dir, task_name + ".json")
                # lines = open(task_txt, 'r').readlines()
                lines = json.load(open(task_txt, 'r'))
                ...
                for img_items in chunk_lines:
                    ...
                    for img_item in img_items:
                        # img_name, question, gt_ans, pred_ans, reason = img_item.split("\t")
                        img_name, question, gt_ans, pred_ans = img_item['image_name'], img_item['question'], img_item['ans'], img_item['result']['output']

...
from chatuniv_utils import ModelInference, remove_special_tokens
...
def main(model_path, model_base, data_path, output_dir, output_name, chunk_idx, chunks, video_dir=None, model_max_length=None, **kwargs):    
    ...
    tokenizer, model, image_processor, _ = load_pretrained_model(model_path, model_base, model_name, device_map={"":0})
